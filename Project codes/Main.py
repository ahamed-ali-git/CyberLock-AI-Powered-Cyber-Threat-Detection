...
def open_email_attack_functionality():
    subprocess.Popen(["python", "Email_Attack.py"])  
...
# Owner details
owner_details = """
App Owner: Ahamed Ali Z
Owner Email: ahamedaliz650@gmail.com
Instagram ID: ahamed_ali__07
GitHub ID: ahamed-ali-git
"""

owner_label = ctk.CTkLabel(master=description_frame, text=owner_details, font=("Arial", 15), justify=ctk.LEFT,
                           text_color="skyblue")  
owner_label.pack(pady=20, padx=10)  


def open_help_page():
    phone_label = ctk.CTkLabel(master=description_frame, text="Phone Number: +91 9448977671", font=("Arial", 15), justify=ctk.LEFT,
                               text_color="skyblue")  
